        ...
        return (
            <div className="row">
                <div className="col-sm-3 visitors">
                    <FontAwesomeIcon icon="eye" className="icons" size="3x" />
                    <strong>{data.visitors}</strong>
                    <p>Visitors</p>
                </div>
                <div className="col-sm-3 users">
                    <FontAwesomeIcon icon="users" className="icons" size="3x" />
                    <strong>{data.users}</strong>
                    <p>Users</p>
                </div>
                <div className="col-sm-3 sales">
                    <FontAwesomeIcon icon="dollar-sign" className="icons" size="3x" />
                    <strong>{data.sales}</strong>
                    <p>Sales</p>
                </div>
                <div className="col-sm-3 orders">
                    <FontAwesomeIcon icon="shopping-cart" className="icons" size="3x" />
